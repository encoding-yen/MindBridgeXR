...
// detector, and the MQTT publisher) can check them without re-reading the sensor.
float lastAccelX = 0, lastAccelY = 0, lastAccelZ = 0; // g
float lastGyroX = 0, lastGyroY = 0, lastGyroZ = 0;    // deg/s
float lastMagX = 0, lastMagY = 0, lastMagZ = 0;       // uT
...
inline float getAccelX() { return lastAccelX; }
inline float getAccelY() { return lastAccelY; }
inline float getAccelZ() { return lastAccelZ; }

inline float getMagX() { return lastMagX; }
inline float getMagY() { return lastMagY; }
inline float getMagZ() { return lastMagZ; }
